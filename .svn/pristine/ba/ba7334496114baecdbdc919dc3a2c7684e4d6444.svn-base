...
<section id="rating">
    ...
    {if isset($displayplayverwaltung) && $displayplayverwaltung == TRUE}
    <section id="pl_add">
        <button id="pladd" class="fa fa-th-list playlistbutton">
            <span>Playlist verwalten</span>
        </button>
    </section>
    {/if}
    {if isset ($displaycatverwaltung) && $displaycatverwaltung == TRUE}
    <section id="cat_add">
        <button id="catadd" class="fa fa-map-signs categoriebutton">
