...
function content_57810e9136e9c7_09901080 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
<!-- Content -->
    ...
    <section id="addVideoToPlaylistForm" class="content">
        <form method="post" action="" id="playdform" name="playdform">
...
?>
            ...
            <button type="submit" name="plset" class="btn btn-info">
                <i class="fa fa-minus-square white" aria-hidden="true"></i> Zu Playlist hinzufügen
            </button>
            <button type="submit" class="btn-btn-info" name="deletefrompl">
                <i class="icon-remove-sign"></i> Von Playlist löschen
            </button>
...
<section id="rating">
    ...
    <div class="rating-wrapper">
        <input type="radio" class="rating-input" <?php if ($_smarty_tpl->tpl_vars['ownRating']->value == 5) {?>checked<?php }?> id="rating-input-1-5" name="rating-input-5"/>
        <label for="rating-input-1-5" class="rating-star"></label>
        <input type="radio" class="rating-input" <?php if ($_smarty_tpl->tpl_vars['ownRating']->value == 4) {?>checked<?php }?> id="rating-input-1-4" name="rating-input-4"/>
        <label for="rating-input-1-4" class="rating-star"></label>
        <input type="radio" class="rating-input" <?php if ($_smarty_tpl->tpl_vars['ownRating']->value == 3) {?>checked<?php }?> id="rating-input-1-3" name="rating-input-3"/>
        <label for="rating-input-1-3" class="rating-star"></label>
        <input type="radio" class="rating-input" <?php if ($_smarty_tpl->tpl_vars['ownRating']->value == 2) {?>checked<?php }?> id="rating-input-1-2" name="rating-input-2"/>
        <label for="rating-input-1-2" class="rating-star"></label>
        <input type="radio" class="rating-input" <?php if ($_smarty_tpl->tpl_vars['ownRating']->value == 1) {?>checked<?php }?> id="rating-input-1-1" name="rating-input-1"/>
